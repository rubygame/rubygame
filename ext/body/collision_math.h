...
extern int rg_collidable_collide_ftor_ftor(rg_ftor *a, rg_ftor *b);
extern int rg_collidable_collide_ftor_segment(rg_ftor *a, rg_segment *b);
extern int rg_collidable_collide_ftor_rect(rg_ftor *a, rg_rect *b);
extern int rg_collidable_collide_ftor_circle(rg_ftor *a, rg_circle *b);
