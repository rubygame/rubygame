...
module Rubygame
  ...
  # to check if an object is an event or not.
	...
	#          :capslock::     Caps lock
	#          :compose::      Compose key
	#          :left_alt::     Alt key (left side)
	#          :left_ctrl::    Ctrl key (left side)
	#          :left_meta::    Meta key (left side)
	#          :left_shift::   Shift key (left side)
	#          :left_super::   Super key, aka. Windows key (left side)
	#          :mode::         Mode key
	#          :numlock::      Num lock
	#          :right_alt::    Alt key (right side)
	#          :right_ctrl::   Ctrl key (right side)
	#          :right_meta::   Meta key (right side)
	#          :right_shift::  Shift key (right side)
	#          :right_super::  Super key, aka. Windows key (right side)
	#
